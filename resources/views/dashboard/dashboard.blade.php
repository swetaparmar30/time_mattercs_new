                                                                ...
                                                                <tr class="unread">
                                                                    <td>
                                                                        ...
                                                                        @else
                                                                            <img class="rounded-circle"
                                                                                style="width:40px;height:40px;"
                                                                                src="{{ asset('assets/images/user/img-demo_1041.jpg') }}"
                                                                                alt="activity-user">
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <h6 class="text-muted"><i
                                                                                class="fas fa-circle text-c-green f-10 m-r-15"></i><span>{{ \Carbon\Carbon::parse($val->updated_at)->format('d M Y') }}</span>
                                                                        </h6>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                            ...
                                            <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="{{ asset('assets/images/user/avatar-2.jpg') }}" alt="activity-user">Albert Andersen</h6>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="{{ asset('assets/images/user/avatar-3.jpg') }}" alt="activity-user">Silje Larsen</h6>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="{{ asset('assets/images/user/avatar-1.jpg') }}" alt="activity-user">Ida Jorgensen</h6>
                                                            </td>
                                                            <td>
                                                                <h6 class="m-0">The quick brown fox</h6>
                                                            </td>
