                                ...
                                <div class="card-block px-0 py-3">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                ...
                                                <textarea class="form-control rich-text-editor" id="code_preview0" name="article_content" style="height: 300px;" data-parsley-required="true" data-parsley-required-message="Please enter Content" data-parsley-errors-container="#content_required">{{ isset($article->content) ? $article->content : '' }}</textarea>
                            ...
                            <div class="card Recent-Users next-box">
                                ...
                                <div class="card-block px-0 py-3">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                <textarea class="form-control" name="meta_description" id="" rows="5" cols="10">{{ isset($article->meta_description) ? $article->meta_description : '' }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-sec">
                                        ...
                                        <div class="row form-sec">
                                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 label-sec">
                                                <div class="upload-img-sec text-center">
                                                    ...
                                                    <img src="{{ $imgpath }}" alt="" id="profile_avtar" class="profile-img" id="profile_avtar"> 
                                                    <a id="remove_image"> <i class="fa fa-times" aria-hidden="true"></i></a>
                                                    </div>
                                                    @else
                                                    <div class="image_preview_div" >
                                                    <img src="{{ $imgpath }}" alt="" id="profile_avtar" class="profile-img"> 
