...
var addToMenu = function (menuname,url) {
  ...
  //   'data-new="1" ' +
  //   'data-deleted="0">' +
  //   '<div class="accordion-item mb-2 dd-handle" style="border-top: 1px solid #e3e3e3;">'+
  //   '<h2 class="accordion-header" id="headingFour">'+
  //   '<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse'+ newIdCount +'" '+
  //   'aria-expanded="false" aria-controls="collapse'+ newIdCount +'">' + menuname + '</button><h2>'+
  //   '<div id="collapse'+newIdCount +'" class="accordion-collapse collapse" aria-labelledby="headingFour"data-bs-parent="#accordionExample2">'+
  //   '<div class="accordion-body">'+
  //   '<form id="" action="" data-parsley-validate="" novalidate="">'+
  //   '<div class="mb-3"><label class="form-label" for="exampleFormControlInput1">Menu Name</label>'+
  //   '<input class="form-control" id="custom_url" name="custom_url" type="text" placeholder="Menu Name" value="'+ menuname +'" data-parsley-required-message="Please Enter URL">'+
  //   '</div><div class="mb-3"><label class="form-label" for="exampleFormControlInput1">URL</label>'+
  //   '<input class="form-control" id="custom_link" value="'+url+'" name="custom_link" type="text" placeholder="URL" data-parsley-required-message="Please Enter URL">'+
  //   '</div><div class="mb-3"><a type="" class="">Save</a></div></form></div></div></div>'+
  //   '</div>'+
  //   '</li>'
  // );
  ...
  nestableList.append(
    ...
    'data-new="1" ' +
    'data-deleted="0">' +
    '<div class="dd-handle"><i class="feather icon-command"></i>' + newName + '</div> ' +
